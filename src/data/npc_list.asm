...
Hut_npcs:
    .byte 1
    .byte %00100001, 104, 94, 0, 20

villager2_npcs:
    .byte 1
    .byte %01000001, 104, 94, 0, 20

villager3_npcs:
    .byte 1
    .byte %01010001, 104, 94, 0, 20
...
cave_npcs:
    .byte 1
    .byte %01100001, 45, 90, 1, 100

dark_cave_npcs:
    .byte 6
    .byte %00000001, 64,  70,  0, 7
    .byte %00000001, 200, 184, 0, 7
    .byte %00000001, 208, 104, 0, 7
    .byte %00000001, 62,  56,  1, 7
    .byte %00000001, 48,  176, 1, 7
