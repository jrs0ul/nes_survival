...
npc_BOSS_frame_DTH:
    ...
    .byte 0,  $0D, %00000000, 16
    .byte 0,  $0C, %01000000, 24

    .byte 8,  $1C, %00000000, 0
    .byte 8,  $FD, %00000000, 8
    .byte 8,  $FD, %00000000, 16
    .byte 8,  $1C, %01000000, 24

    .byte 16, $1C, %00000000, 0
    .byte 16, $FD, %00000000, 8
    .byte 16, $FD, %00000000, 16
    .byte 16, $1C, %01000000, 24

    .byte 24, $1C, %00000000, 0
    .byte 24, $FD, %00000000, 8
    .byte 24, $FD, %00000000, 16
    .byte 24, $1C, %01000000, 24

    .byte 32, $0C, %10000000, 0
    .byte 32, $0D, %10000000, 8
    .byte 32, $0D, %10000000, 16
    .byte 32, $0C, %11000000, 24
...
npc_BOSS_frame_UP_ATK:
    ...
    .byte 32, $EC, %00000000, 0
    .byte 32, $ED, %00000000, 8
    .byte 32, $EE, %00000000, 16
    .byte 32, $EF, %00000000, 24
...
npc_BOSS_frame_DOWN_ATK:
    ...
    .byte 32, $FE, %00000000, 0
    .byte 32, $2C, %00000000, 8
    .byte 32, $3E, %00000000, 16
