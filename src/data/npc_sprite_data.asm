...
;frame 1
    .byte 0, $2C, %00000000, 0
    .byte 0, $2C, %01000000, 8
    .byte 8, $3D, %00000000, 0
    .byte 8, $3D, %01000000, 8
;frame 2
    .byte 0, $0D, %00000000, 0
    .byte 0, $0D, %01000000, 8
    .byte 8, $1D, %00000000, 0
...
;frame 1
    ...
    .byte 8, $AC, %01000000, 8
;frame 2
    .byte 0, $BC, %00000000, 0
    .byte 0, $7C, %01000000, 8
    .byte 8, $CC, %00000000, 0
    .byte 8, $8C, %01000000, 8
;frame 3
    .byte 0, $9C, %00000000, 0
    .byte 0, $9D, %00000000, 8
    .byte 8, $AC, %00000000, 0
...
;frame 1
    ...
    .byte 0, $9E, %01000000, 8
    .byte 8, $AE, %00000000, 0
    .byte 8, $AE, %01000000, 8
;frame 2
    .byte 0, $7E, %00000000, 0
    .byte 0, $7E, %01000000, 8
    .byte 8, $CE, %00000000, 0
    .byte 8, $8E, %01000000, 8
;frame 3
    .byte 0, $9E, %00000000, 0
    .byte 0, $9E, %01000000, 8
    .byte 8, $AE, %00000000, 0
